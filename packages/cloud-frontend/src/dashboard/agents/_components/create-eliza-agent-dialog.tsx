            ...
            <>
              <div className="space-y-4 py-2">
                ...
                {/* Image selector — only meaningful when Dedicated.
                    getAgentFlavorsForEnv() holds the env-filtered Docker image
                    choices ("Eliza Agent" / "(Develop)" / "Custom Image"); we
                    hide it for Shared because no image is ever sent in that
                    mode. */}
                {isDedicated && (
                  <div className="space-y-1.5">
                    <Label
